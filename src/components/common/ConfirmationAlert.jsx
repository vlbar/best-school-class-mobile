...
export function ButtonedConfirmationAlert({ title, text, buttons, onReject, onConfirm, show = false }) {
  const { translate } = useTranslation();
  ...
  function confirm() {
    Alert.alert(title ?? translate('common.confirmation'), text, (buttons ?? defaultButtons));
  }
